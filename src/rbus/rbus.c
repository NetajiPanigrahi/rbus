...
rbusError_t rbus_get(rbusHandle_t handle, char const* name, rbusValue_t* value)
{
    ...
    err = rbus_invokeRemoteMethod2(myConn, name, METHOD_GETPARAMETERVALUES, request, (50 * 1000) /*rbusConfig_ReadGetTimeout()*/, &response);
            ...
            *numValues = 0;
            ...
            else
            {
                for(i = 0; i < numDestinations; i++)
                {
                    ...
                    /* Invoke the method */
                    err = rbus_invokeRemoteMethod(destinations[i], METHOD_GETPARAMETERVALUES, request, (50 * 1000)/*rbusConfig_ReadGetTimeout()*/, &response);
        ...
        rbusEventSubscriptionInternal_t* subInternal)
{
    ...
    coreerr = rbus_unsubscribeFromEvent(NULL, subscription->eventName, payload);
